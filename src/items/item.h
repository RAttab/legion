...
enum legion_packed item
{
    ...
    // T1
    ITEM_LIQUID_FRAME = ITEM_PASSIVE_FIRST + 0x10,
    ITEM_RADIATION    = ITEM_PASSIVE_FIRST + 0x11,
    ITEM_ANTENNA      = ITEM_PASSIVE_FIRST + 0x12,
    ITEM_ACCELERATOR  = ITEM_PASSIVE_FIRST + 0x13,
    ...
    // T1
    ITEM_SOLAR        = ITEM_ACTIVE_FIRST + 0x10,
    ITEM_STORAGE      = ITEM_ACTIVE_FIRST + 0x11,
    ITEM_PORT         = ITEM_ACTIVE_FIRST + 0x12,
    ITEM_CONDENSER    = ITEM_ACTIVE_FIRST + 0x13,
    ITEM_ENERGY_STORE = ITEM_ACTIVE_FIRST + 0x14,
    ITEM_AUTO_DEPLOY  = ITEM_ACTIVE_FIRST + 0x15,
    ITEM_TRANSMIT     = ITEM_ACTIVE_FIRST + 0x16,
    ITEM_RECEIVE      = ITEM_ACTIVE_FIRST + 0x17,
