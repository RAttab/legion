...
enum legion_packed item
{
    ...
    ITEM_PROBER   = ITEM_ACTIVE_FIRST + 0x06,
    ITEM_SCANNER  = ITEM_ACTIVE_FIRST + 0x07,
    ITEM_LEGION   = ITEM_ACTIVE_FIRST + 0x08,
    ITEM_LAB      = ITEM_ACTIVE_FIRST + 0x09,
    ...
    // T2
    ITEM_COLLIDER = ITEM_ACTIVE_FIRST + 0x20,
    ITEM_PACKER   = ITEM_ACTIVE_FIRST + 0x21,
    ITEM_NOMAD    = ITEM_ACTIVE_FIRST + 0x22,
