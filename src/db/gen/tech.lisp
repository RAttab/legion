...
(pentadylchuate
  ...
  (tape (work 10) (energy 19) (host assembly)
    (in (item-monobarex 22)
        (item-monocharkoid 3)
        (item-monobarols 11)
        (item-duochuium 3)
        (item-tetradylchuitil-duobar 1))
