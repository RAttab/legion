...
(pentadylchutor
  ...
  (tape (work 9) (energy 15) (host item-assembly)
    ...
    (info (rank 5)
          (reqs (item-duodylium 3)
                (item-tetradylchols-tribarsh 2))
          (elems (item-elem-a 54)
                 (item-elem-b 130)
                 (item-elem-c 45)
                 (item-elem-d 44))))
  (dbg
...
(hexadylchate-pentabaron
  ...
  (tape (work 13) (energy 21) (host item-assembly)
    ...
    (info (rank 6)
          (reqs (item-monobarols 6)
                (item-pentadylchutor 2))
          (elems (item-elem-a 108)
                 (item-elem-b 302)
                 (item-elem-c 90)
                 (item-elem-d 88))))
  (dbg
...
(collider
  ...
  (tape (work 42) (energy 33) (host item-assembly)
    ...
    (out (item-collider 1))
    (info (rank 7)
          (reqs (item-tridylarkitil 1)
                (item-rod 1)
                (item-trifimbarsh 4)
                (item-trerlchury-duobargen 6)
                (item-trichubarium 5)
                (item-accelerator 2))
          (elems (item-elem-a 3858)
                 (item-elem-b 3366)
                 (item-elem-c 3296)
                 (item-elem-d 1336)
                 (item-elem-e 780)
...
(nomad
  ...
  (tape (work 100) (energy 135) (host item-assembly)
    ...
    (out (item-nomad 1))
    (info (rank 8)
          (reqs (item-monobarols 32)
                (item-trifimate 5)
                (item-pentamoxate 2)
                (item-packer 1))
          (elems (item-elem-a 5208)
                 (item-elem-b 2564)
                 (item-elem-c 2285)
                 (item-elem-d 983)
                 (item-elem-e 1600)
