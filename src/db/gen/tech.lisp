...
(tridylgen
  ...
  (tape (work 8) (energy 13) (host item-assembly)
    ...
    (info (rank 3)
          (reqs (item-duodylchalt-monobarols 2))
          (elems (item-elem-a 2)
                 (item-elem-b 6)
                 (item-elem-c 2)
                 (item-elem-d 2))))
...
(pentamoxate
  ...
  (tape (work 47) (energy 59) (host item-printer)
    ...
    (info (rank 5)
          (reqs (item-duodylchalt-monobarols 9)
                (item-duarksh 5)
                (item-duerltor 1)
                (item-duerlry 1)
                (item-duerldylon-monochols 2)
                (item-tridylate 2)
                (item-elem-m 15))
...
(hexamoxchoid-monobary
  ...
  (tape (work 50) (energy 87) (host item-assembly)
    ...
    (info (rank 6)
          (reqs (item-duodylchalt-monobarols 7)
                (item-duarksh 1)
                (item-duerldylon-monochols 3)
                (item-pentamoxate 1))
...
(packer
  ...
  (tape (work 68) (energy 130) (host item-assembly)
    ...
    (out (item-packer 1))
    (info (rank 7)
          (reqs (item-duodylchalt-monobarols 32)
                (item-duarksh 32)
                (item-tridylgen 1)
                (item-hexamoxchoid-monobary 1))
