...
(tetradylchitil-duobara
  ...
  (tape (work 8) (energy 15) (host assembly)
    (in (item-duodylium 2)
        ...
        (item-monobarex 11)
        (item-monobarols 5))
    (out (item-tetradylchitil-duobara 1)))
  (dbg
    (info (id 4f) (layer 4))
