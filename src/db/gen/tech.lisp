(elem-a
  ...
  (tape (work 1) (energy 1) (host extract)
    (out (item-elem-a 1)))
  (dbg
    (info (id 1) (layer 0))
    (work (min 1) (total 1))
...
(elem-b
  (info (type natural))
  (specs (lab-bits u8 1) (lab-work work 1) (lab-energy energy 1))
  (tape (work 2) (energy 2) (host extract)
    (out (item-elem-b 1)))
  (dbg
    (info (id 2) (layer 0))
    (work (min 2) (total 2))
...
(elem-c
  (info (type natural))
  (specs (lab-bits u8 1) (lab-work work 1) (lab-energy energy 1))
  (tape (work 2) (energy 4) (host extract)
    (out (item-elem-c 1)))
  (dbg
    (info (id 3) (layer 0))
    (work (min 2) (total 2))
...
(elem-o
  (info (type synth))
  (specs (lab-bits u8 1) (lab-work work 1) (lab-energy energy 1))
  (tape (work 1) (energy 1) (host dummy)
    (out (item-elem-o 1)))
  (dbg
    (info (id 4) (layer 0))
    (work (min 1) (total 1))
...
(elem-g
  (info (type natural))
  (specs (lab-bits u8 1) (lab-work work 1) (lab-energy energy 1))
  (tape (work 16) (energy 32) (host extract)
    (out (item-elem-g 1)))
  (dbg
    (info (id 5) (layer 0))
...
(elem-h
  (info (type natural))
  (specs (lab-bits u8 1) (lab-work work 1) (lab-energy energy 1))
  (tape (work 16) (energy 42) (host condenser)
    (out (item-elem-h 1)))
  (dbg
    (info (id 6) (layer 0))
    (work (min 16) (total 16))
...
(elem-d
  ...
  (tape (work 4) (energy 6) (host extract)
    (in (item-elem-b 2))
    (out (item-elem-d 1)))
  (dbg
    (info (id 10) (layer 1))
...
(monobarex
  ...
  (tape (work 3) (energy 3) (host printer)
    (in (item-elem-b 1)
        (item-elem-a 5))
...
(monocharkoid
  ...
  (tape (work 3) (energy 6) (host printer)
    (in (item-elem-c 3)
        (item-elem-a 2)
        (item-elem-c 2))
...
(elem-e
  ...
  (tape (work 8) (energy 4) (host condenser)
    (in (item-elem-c 1)
        (item-elem-a 3))
    (out (item-elem-e 1)))
  (dbg
...
(monochuate
  ...
  (tape (work 3) (energy 5) (host printer)
    (in (item-elem-c 32))
    (out (item-monochuate 1)))
  (dbg
    (info (id 1c) (layer 1))
    (work (min 3) (total 67))
    (energy 271)
...
(monoarkols
  ...
  (tape (work 2) (energy 2) (host printer)
    (in (item-elem-a 17))
    (out (item-monoarkols 1)))
  (dbg
    (info (id 1f) (layer 1))
    (work (min 2) (total 19))
    (energy 21)
...
(extract
  ...
  (tape (work 4) (energy 4) (host assembly)
    (in (item-monobarex 3)
        (item-monobararkon 1))
    (out (item-extract 1)))
  (dbg
...
(printer
  ...
  (tape (work 4) (energy 7) (host assembly)
...
(duodylium
  ...
  (tape (work 5) (energy 8) (host printer)
    (in (item-elem-c 2)
        (item-elem-d 2)
        (item-elem-c 3))
...
(elem-f
  ...
  (tape (work 12) (energy 8) (host condenser)
    (in (item-elem-e 1)
        (item-elem-d 1))
    (out (item-elem-f 1)))
  (dbg
...
(duoerlex
  ...
  (tape (work 10) (energy 9) (host printer)
    (in (item-elem-e 24)
        (item-elem-d 32)
        (item-elem-e 8))
    (out (item-duoerlex 1)))
...
(duodylitil
  ...
  (tape (work 6) (energy 8) (host printer)
    (in (item-elem-b 16)
        (item-elem-d 26)
        (item-elem-b 2)
        (item-elem-d 6)
...
(duoerltor
  ...
  (tape (work 12) (energy 6) (host printer)
...
(duoerlry
  ...
  (tape (work 11) (energy 8) (host printer)
...
(duoerldylon-monochuols
  ...
  (tape (work 9) (energy 9) (host printer)
    (in (item-monobarols 1)
        ...
        (item-monobarex 1)
        (item-monocharkoid 3))
    (out (item-duoerldylon-monochuols 1)))
  (dbg
    (info (id 2e) (layer 2))
...
(duochuium
  ...
  (tape (work 4) (energy 7) (host assembly)
    (in (item-monocharkoid 4)
        (item-monobarex 3)
        (item-monobararkon 1)
        (item-monocharkoid 1))
    (out (item-duochuium 1)))
  (dbg
    (info (id 2f) (layer 2))
...
(tridylarkitil
  ...
  (tape (work 6) (energy 10) (host assembly)
    (in (item-duodylium 3)
        (item-monocharkoid 1)
        (item-duodylium 2)
        (item-monocharkoid 1))
...
(deploy
  ...
  (tape (work 8) (energy 11) (host assembly)
...
(rod
  ...
  (tape (work 7) (energy 12) (host assembly)
    (in (item-duodylium 3)
        (item-extract 1)
        (item-monoarkols 1)
        (item-duodylium 5))
...
(tridylate
  ...
  (tape (work 6) (energy 9) (host printer)
    (in (item-elem-d 17))
...
(trifimate
  ...
  (tape (work 16) (energy 11) (host printer)
    (in (item-elem-f 27)
        (item-elem-c 2)
        (item-elem-f 5)
        (item-elem-c 2))
...
(trifimbarsh
  ...
  (tape (work 17) (energy 10) (host printer)
    (in (item-duoerldylon-monochuols 1)
        (item-duodylium 1)
        (item-elem-f 32)
        (item-duoerltor 1)
        (item-duodylium 2))
...
(trierlchury-duobargen
  (info (type passive))
  (specs (lab-bits u8 10) (lab-work work 69) (lab-energy energy 8))
  (tape (work 15) (energy 10) (host assembly)
    (in (item-duoerldylon-monochuols 1)
        (item-duoerlry 1))
    (out (item-trierlchury-duobargen 1)))
  (dbg
    (info (id 3e) (layer 3))
...
(trichubarium
  ...
  (tape (work 6) (energy 8) (host assembly)
    (in (item-monocharkoid 8)
        (item-duochuium 1)
        (item-monoarkols 1))
...
(assembly
  (info (type active) (config printer))
  (specs (lab-bits u8 13) (lab-work work 89) (lab-energy energy 14))
  (tape (work 8) (energy 12) (host assembly)
    (in (item-monobarex 2)
        (item-monobararkon 1)
...
(fusion
  ...
  (tape (work 7) (energy 13) (host assembly)
    (in (item-extract 1)
...
(worker
  ...
  (tape (work 8) (energy 13) (host assembly)
    (in (item-tridylarkitil 2)
        (item-monobarex 3)
        (item-printer 3))
    (out (item-worker 1)))
  (dbg
...
(storage
  ...
  (specs
    ...
    (max u16 4096))
  (tape (work 16) (energy 15) (host assembly)
    (in (item-monobarex 1)
        (item-monocharkoid 9)
        (item-printer 2)
        (item-monocharkoid 5)
...
(solar
  ...
  (tape (work 18) (energy 11) (host assembly)
    (in (item-monobarex 18)
        (item-trifimbarsh 1)
        (item-monobarols 7))
    (out (item-solar 1)))
  (dbg
...
(elem-l
  ...
  (tape (work 20) (energy 50) (host collider)
    (in (item-elem-e 8)
        (item-elem-d 2)
        (item-elem-e 7)
        (item-elem-d 18))
...
(elem-m
  ...
  (tape (work 36) (energy 50) (host collider)
    (in (item-elem-e 6)
        (item-elem-f 5)
        (item-elem-e 3)
        (item-elem-f 5)
...
(tetradylchuols-tribars
  ...
  (tape (work 8) (energy 14) (host assembly)
    (in (item-monobararkon 1)
        ...
        (item-monobarex 1)
        (item-tridylate 1))
    (out (item-tetradylchuols-tribars 1)))
  (dbg
    (info (id 4b) (layer 4))
...
(tetrafimalt
  ...
  (tape (work 22) (energy 12) (host assembly)
    (in (item-trifimate 1)
        (item-duoerltor 1)
        (item-tridylate 2))
...
(tetrafimry
  ...
  (tape (work 24) (energy 17) (host assembly)
    (in (item-monochuate 2)
        (item-trifimate 1))
...
(tetraerlbargen
  ...
  (tape (work 19) (energy 11) (host assembly)
    (in (item-trierlchury-duobargen 1)
        (item-monoarkols 2)
        (item-duodylitil 1)
        (item-tridylarkitil 1))
    (out (item-tetraerlbargen 1)))
  (dbg
    (info (id 4e) (layer 4))
...
(tetradylchuitil-duobar
  (info (type passive))
  (specs (lab-bits u8 22) (lab-work work 32) (lab-energy energy 9))
  (tape (work 8) (energy 15) (host assembly)
    (in (item-duodylium 2)
        ...
        (item-monobarols 6)
        (item-duodylium 1))
    (out (item-tetradylchuitil-duobar 1)))
  (dbg
    (info (id 4f) (layer 4))
...
(brain
  ...
  (tape (work 11) (energy 13) (host assembly)
    (in (item-rod 1)
        (item-tridylarkitil 3)
        (item-monobarols 7)
        (item-duodylium 3)
...
(prober
  ...
  (tape (work 10) (energy 16) (host assembly)
    (in (item-duodylium 1)
        (item-memory 1)
        (item-rod 1)
        (item-memory 1)
...
(battery
  ...
  (tape (work 23) (energy 23) (host assembly)
    (in (item-monochury 2)
        (item-tridylarkitil 1)
        (item-deploy 1)
        (item-storage 1)
...
(receive
  ...
  (specs
    ...
    (buffer-max enum 1))
  (tape (work 16) (energy 13) (host assembly)
    (in (item-duodylitil 4)
        (item-duoerltor 3)
        (item-duodylium 3)
        (item-duoerldylon-monochuols 1)
        (item-memory 2))
    (out (item-receive 1)))
  (dbg
    (info (id 53) (layer 5))
...
(elem-n
  ...
  (tape (work 42) (energy 50) (host collider)
    (in (item-elem-l 10)
        (item-elem-m 2))
    (out (item-elem-n 1)))
  (dbg
...
(pentamoxate
  ...
  (tape (work 47) (energy 59) (host printer)
    (in (item-tridylate 1)
        (item-duodylium 1)
        (item-elem-m 5)
        (item-duoerltor 1)
...
(pentadylchutor
  ...
  (tape (work 9) (energy 15) (host assembly)
    (in (item-tetradylchuols-tribars 1)
        (item-duodylium 3)
        (item-tetradylchuols-tribars 1))
...
(pentalofchuols
  ...
  (tape (work 24) (energy 56) (host printer)
    (in (item-elem-l 10)
        (item-tridylate 1)
        (item-monobarols 4)
        (item-tridylate 1)
...
(pentafimchuex-monobars
  (info (type passive))
  (specs (lab-bits u8 20) (lab-work work 65) (lab-energy energy 18))
  (tape (work 24) (energy 16) (host assembly)
    (in (item-tetrafimalt 1)
        (item-duodylitil 1)
        (item-monoarkols 2))
    (out (item-pentafimchuex-monobars 1)))
  (dbg
    (info (id 5d) (layer 5))
...
(pentaerltor
  ...
  (tape (work 27) (energy 13) (host assembly)
    (in (item-monocharkoid 1)
        (item-monoarkols 1)
        (item-monobarex 1)
        (item-monoarkols 1)
        (item-tetraerlbargen 1)
        (item-monobarex 19))
    (out (item-pentaerltor 1)))
  (dbg
    (info (id 5e) (layer 5))
...
(pentadylchuate
  ...
  (tape (work 10) (energy 19) (host assembly)
    (in (item-tetradylchuitil-duobar 1)
        (item-monobarex 11)
        (item-monocharkoid 1)
        (item-duochuium 1)
        (item-monobarols 5)
...
(lab
  ...
  (tape (work 14) (energy 20) (host assembly)
...
(scanner
  ...
  (specs
    ...
    (work-energy energy 8) (work-cap fn))
  (tape (work 13) (energy 21) (host assembly)
    (in (item-printer 1)
        (item-rod 1)
        (item-monobarex 4)
        (item-brain 1)
...
(condenser
  (info (type active) (config extract))
  (specs (lab-bits u8 14) (lab-work work 94) (lab-energy energy 42))
  (tape (work 11) (energy 24) (host assembly)
    (in (item-monocharkoid 15)
        (item-monoarkols 1)
        (item-extract 1)
        (item-monocharkoid 1)
        (item-monoarkols 1)
        ...
        (item-monobarex 1)
        (item-monochury 1)
        (item-pentadylchuate 1)
        (item-monoarkols 3)
        (item-printer 7)
        (item-monocharkoid 1)
        (item-monoarkols 1)
        (item-monocharkoid 15))
...
(pill
  ...
  (tape (work 40) (energy 19) (host assembly)
    (in (item-monocharkoid 3)
        (item-monobarols 1)
        (item-monocharkoid 1)
        (item-monobarols 21)
...
(transmit
  ...
  (tape (work 35) (energy 18) (host assembly)
    (in (item-deploy 2)
        (item-receive 1)
        (item-rod 1)
        (item-monochuate 3)
...
(port
  ...
  (tape (work 34) (energy 22) (host assembly)
    (in (item-storage 1)
        (item-pentafimchuex-monobars 1)
        (item-duoerlex 1)
        (item-trifimate 1)
        (item-worker 2)
        (item-storage 1))
...
(accelerator
  ...
  (tape (work 31) (energy 24) (host assembly)
    (in (item-battery 1)
        (item-tridylate 2)
        (item-tridylarkitil 1)
        (item-deploy 1)
...
(burner
  ...
  (tape (work 36) (energy 77) (host assembly)
    (in (item-monoarkols 10)
        (item-pentalofchuols 1)
        (item-deploy 1)
        (item-duodylium 1))
    (out (item-burner 1)))
  (dbg
...
(hexamoxchuoid-monobarr
  (info (type passive))
  (specs (lab-bits u8 22) (lab-work work 120) (lab-energy energy 80))
  (tape (work 50) (energy 87) (host assembly)
    (in (item-duoerldylon-monochuols 2)
        (item-duodylium 1)
        (item-duoerldylon-monochuols 1)
        (item-duodylium 1)
        (item-pentamoxate 1)
        (item-duodylium 1))
    (out (item-hexamoxchuoid-monobarr 1)))
  (dbg
    (info (id 6e) (layer 6))
...
(hexadylchuate-pentabar
  (info (type passive))
  (specs (lab-bits u8 34) (lab-work work 80) (lab-energy energy 73))
  (tape (work 13) (energy 21) (host assembly)
    (in (item-pentadylchutor 1)
        (item-monobarols 6)
        (item-pentadylchutor 1))
    (out (item-hexadylchuate-pentabar 1)))
  (dbg
    (info (id 6f) (layer 6))
...
(legion
  ...
  (tape (work 14) (energy 30) (host assembly)
    (in (item-duodylium 7)
        (item-hexadylchuate-pentabar 1)
        (item-deploy 1)
        (item-extract 1)
        (item-monobarols 1)
        (item-fusion 1)
...
(collider
  ...
  (specs
	...
	(output-rate fn))
  (tape (work 42) (energy 33) (host assembly)
    (in (item-trichubarium 3)
        (item-trifimbarsh 1)
        (item-rod 1)
        (item-trifimbarsh 1)
        (item-trichubarium 2)
...
(packer
  ...
  (tape (work 68) (energy 130) (host assembly)
    (in (item-printer 1)
        (item-deploy 1)
        (item-printer 1)
        (item-hexamoxchuoid-monobarr 1)
        (item-rod 2))
    (out (item-packer 1)))
  (dbg
    (info (id 72) (layer 7))
...
(nomad
  ...
  (specs
	...
	(cargo-len enum 12)
	(cargo-max u8 255))
  (tape (work 100) (energy 135) (host assembly)
...
(test
  ...
  (tape (work 1) (energy 1) (host assembly)
    (out (item-test 1)))
  (dbg
    (info (id f4) (layer 15))
    (work (min 1) (total 1))
