...
// -----------------------------------------------------------------------------
  ...
  item_furnace              = 0x26,
  item_galvanic             = 0x27,
  item_heat_exchange        = 0x28,
  item_lens                 = 0x29,
  item_limb                 = 0x2a,
  item_lung                 = 0x2b,
  item_m_condenser          = 0x2c,
  item_m_lung               = 0x2d,
  item_m_reactor            = 0x2e,
  item_m_release            = 0x2f,
  item_magnet               = 0x30,
  ...
  item_nerve                = 0x32,
  item_neuron               = 0x33,
  item_neurosteel           = 0x34,
  item_nodule               = 0x35,
  item_photovoltaic         = 0x36,
  item_retina               = 0x37,
  item_rod                  = 0x38,
  item_semiconductor        = 0x39,
  item_spinal               = 0x3a,
  item_stem                 = 0x3b,
  item_tendon               = 0x3c,
  item_torus                = 0x3d,
  item_vein                 = 0x3e,
  items_passive_last = 0x3f,
...
// -----------------------------------------------------------------------------
  ...
  items_logistics_first = 0x54,
  item_battery              = 0x54,
  item_kwheel               = 0x55,
  item_pill                 = 0x56,
  item_solar                = 0x57,
  item_worker               = 0x58,
  items_logistics_last = 0x59,
