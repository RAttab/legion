...
const struct op_spec op_specs[] = {
    ...
    [OP_ARG0]   = { .op = OP_ARG0,   .str = "ARG0",   .arg = ARG_LEN },
    [OP_ARG1]   = { .op = OP_ARG1,   .str = "ARG1",   .arg = ARG_LEN },
    [OP_ARG2]   = { .op = OP_ARG2,   .str = "ARG2",   .arg = ARG_LEN },
    [OP_ARG3]   = { .op = OP_ARG3,   .str = "ARG3",   .arg = ARG_LEN },
