...
(progn
  ...
  (unless (is-deployed !item-extract)   (deploy-tape !item-extract 1))
  (unless (is-deployed !item-memory)    (deploy-tape !item-memory 1))
  (unless (is-deployed !item-worker)    (deploy-tape !item-worker 1))
  (unless (is-deployed !item-condenser) (deploy-tape !item-condenser 1))
  (unless (is-deployed !item-solar)     (deploy-tape !item-solar 1))
  (unless (is-deployed !item-battery)   (deploy-tape !item-battery 1))
  (unless (is-deployed !item-transmit)  (deploy-tape !item-transmit 1))
  (unless (is-deployed !item-receive)   (deploy-tape !item-receive 1))
  (unless (is-deployed !item-port)      (deploy-tape !item-port 1))
  (unless (is-deployed !item-pill)      (deploy-tape !item-pill 1))
